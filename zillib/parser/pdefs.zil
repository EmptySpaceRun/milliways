 ...
 (P-THIRD-PART
  <DEFSTRUCT PARSE-RESULT
	...
	;12 (PARSE-OBJ2 <OR FALSE PMEM>)
        (PARSE-OBJ3 <OR FALSE PMEM>)
	    (PARSE-PARTICLE1 <OR FALSE VWORD>)
	    (PARSE-PARTICLE2 <OR FALSE VWORD>)
        (PARSE-PARTICLE3 <OR FALSE VWORD>)
	;22 (PARSE-LOC <OR FALSE PMEM ;PP>)
	    (PARSE-QW <OR FALSE VWORD>)
	    (PARSE-ADJ <OR FALSE VWORD>)
	;28 (PARSE-CHOMPER <OR FALSE PMEM ;NOUN-PHRASE ;OBJECT>)
	    (PARSE-SUBJ <OR FALSE PMEM>)
	    (PARSE-QUERY <OR FALSE VWORD>)
	;34 (PARSE-QUERY-SYNTAX <OR FALSE VERB-SYNTAX>)
	    (PARSE-FLAGS FIX)>
  <CONSTANT PARSE-RESULT-LEN 38>)
 (ELSE
  <DEFSTRUCT PARSE-RESULT
	    (TABLE
	     ('PRINTTYPE TABLE-PRINT))
