...
<SYNONYM MAN GUY MISTER SIR BOY>
<SYNONYM WOMAN LADY MADAM ;MA\'AM MISS MS GIRL>
...
<SYNTAX POINT AT OBJECT WITH OBJECT (HELD CARRIED TAKE HAVE) = V-SAIM PRE-SAIM>
...
<VERB-SYNONYM ATTACK FIGHT ;HIT ;KICK DAMAGE HARM ;PUNCH REPEL ;KILL STAB CUT ;WHACK>
...
<SYNTAX CALL IN OBJECT FOR OBJECT (EVERYWHERE) = V-SCALL PRE-SCALL>
<SYNTAX CALL ON OBJECT FOR OBJECT (EVERYWHERE) = V-SCALL PRE-SCALL>
<SYNTAX CALL WITH OBJECT FOR OBJECT (EVERYWHERE) = V-SCALL PRE-SCALL>
...
<SYNTAX CLIMB THROUGH OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-THROUGH PRE-THROUGH>
...
<SYNTAX CLIMB OBJECT ;(FIND VEHBIT) (ON-GROUND IN-ROOM EVERYWHERE) WITH OBJECT (HELD CARRIED TAKE HAVE) = V-BOARD PRE-BOARDING>
<SYNTAX CLIMB ON OBJECT ;(FIND VEHBIT) (ON-GROUND IN-ROOM) WITH OBJECT (HELD CARRIED TAKE HAVE) = V-CLIMB-ON PRE-BOARDING>
...
<SYNTAX ENTER OBJECT ;(FIND ROOMSBIT) (ON-GROUND IN-ROOM ADJACENT) = V-THROUGH PRE-THROUGH>

<VERB-SYNONYM EXAMINE X INSPECT DESCRIBE STUDY OBSERVE EXPLORE WATCH SEE REGARD>
...
<VERB-SYNONYM FIX REPAIR ADJUST UNJAM CONTROL>
<SYNTAX FIX OBJECT = V-FIX>
<SYNTAX FIX OBJECT WITH OBJECT (HELD CARRIED TAKE HAVE) = V-FIX>
...
<SYNONYM FOOTNOTE NOTE>
<SYNTAX FOOTNOTE OBJECT (FIND ROOMSBIT) = V-FOOTNOTE>

<SYNTAX GET OBJECT (FIND TRYTAKEBIT) (ON-GROUND IN-ROOM MANY)
	= V-TAKE PRE-TAKE>
...
<SYNTAX GET OBJECT ;(FIND TRYTAKEBIT) (MANY TAKE) TO OBJECT (EVERYWHERE) = V-TAKE-TO>
...
<VERB-SYNONYM HAND GIVE SELL OFFER PASS ;FEED>
<SYNTAX HAND OBJECT (MANY HELD HAVE) TO OBJECT (FIND PERSONBIT) (ON-GROUND)
	= V-GIVE PRE-GIVE>
<SYNTAX HAND OBJECT (FIND PERSONBIT) (ON-GROUND) OBJECT (MANY HELD HAVE)
    = V-SGIVE PRE-SGIVE>
...
<SYNTAX HELP = V-HELP>
<SYNTAX HELP OBJECT ;(EVERYWHERE) (FIND PERSONBIT) = V-HELP>
...
<SYNTAX HIDE IN OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-THROUGH PRE-THROUGH>
...
<SYNTAX HOLD OBJECT (FIND TRYTAKEBIT) (ON-GROUND IN-ROOM MANY)
	= V-TAKE PRE-TAKE>
...
<SYNTAX DESCEND OBJECT (FIND ROOMSBIT) (ON-GROUND IN-ROOM EVERYWHERE) = V-CLIMB-DOWN>
...
<SYNTAX LISTEN OBJECT (FIND DARKBIT) (HELD CARRIED ON-GROUND IN-ROOM)
    = V-LISTEN PRE-LISTEN>
<SYNTAX LISTEN TO OBJECT (HELD CARRIED ON-GROUND IN-ROOM)
    = V-LISTEN PRE-LISTEN>
<SYNTAX LISTEN ON OBJECT (HELD CARRIED ON-GROUND IN-ROOM)
    = V-LISTEN PRE-LISTEN>
...
<SYNONYM PANIC WORRY FREAK UNNERVE>
<SYNTAX PANIC = V-PANIC>
<SYNTAX PANIC OUT = V-PANIC> ;"Freak out"

<SYNTAX PAY FOR OBJECT = V-BUY>


<VERB-SYNONYM POUR SPILL SPRINKLE SPLASH EMPTY MIX>
<IF-P-THIRD-PART
    <SYNTAX POUR OBJECT (HELD CARRIED HAVE TAKE)
            IN OBJECT (HELD CARRIED HAVE TAKE)
            WITH OBJECT = V-POUR PRE-POUR-WITH>
    <SYNTAX POUR OBJECT (HELD CARRIED HAVE TAKE)
            WITH OBJECT IN OBJECT (HELD CARRIED
              HAVE TAKE) = V-POUR PRE-POUR-WITH>>
...
<SYNTAX POUR OBJECT (HELD CARRIED HAVE TAKE) IN OBJECT  (HELD CARRIED HAVE TAKE) = V-PUT-IN PRE-PUT-IN>
<SYNTAX POUR OBJECT (HELD CARRIED HAVE TAKE) ON OBJECT  ;(HELD CARRIED HAVE TAKE) = V-PUT PRE-PUT>
<SYNTAX POUR OBJECT (HELD CARRIED HAVE TAKE) OVER OBJECT  ;(HELD CARRIED HAVE TAKE) = V-PUT PRE-PUT>
...
<SYNTAX PULL OBJECT (CARRIED IN-ROOM MANY)
...
<VERB-SYNONYM PLACE PUT STUFF LAY INSERT SET FLASH ADD SWIPE ;"SWIPE CARD AGAINST PANEL" ;" INSTALL DEPOSIT DIP">
...
<SYNTAX TAKE OBJECT (FIND TRYTAKEBIT) (ON-GROUND IN-ROOM MANY)
	= V-TAKE PRE-TAKE>
...
<SYNTAX TAKE UP OBJECT (FIND TRYTAKEBIT) (ON-GROUND IN-ROOM MANY)
	= V-TAKE PRE-TAKE>
...
<SYNTAX SWITCH OBJECT WITH OBJECT (HELD CARRIED TAKE HAVE) = V-FIX>
...
<IF-P-THIRD-PART
    <SYNTAX WRITE OBJECT (EVERYWHERE) ON OBJECT (FIND READBIT)
            WITH OBJECT (HELD CARRIED HAVE TAKE) = V-WRITE-THIRD>
    <SYNTAX WRITE OBJECT (EVERYWHERE) IN OBJECT (FIND READBIT)
            WITH OBJECT (HELD CARRIED HAVE TAKE) = V-WRITE-THIRD>
    <SYNTAX WRITE OBJECT (EVERYWHERE) WITH OBJECT (HELD CARRIED HAVE TAKE)
            ON OBJECT (FIND READBIT) = V-FWRITE-THIRD PRE-FWRITE-THIRD>
    <SYNTAX WRITE OBJECT (EVERYWHERE) WITH OBJECT (HELD CARRIED HAVE TAKE)
            IN OBJECT (FIND READBIT) = V-FWRITE-THIRD PRE-FWRITE-THIRD>
    <SYNTAX WRITE ABOUT OBJECT (EVERYWHERE) ON OBJECT (FIND READBIT)
            WITH OBJECT (HELD CARRIED HAVE TAKE) = V-WRITE-THIRD>
    <SYNTAX WRITE ABOUT OBJECT (EVERYWHERE) IN OBJECT (FIND READBIT)
            WITH OBJECT (HELD CARRIED HAVE TAKE) = V-WRITE-THIRD>
    <SYNTAX WRITE ABOUT OBJECT (EVERYWHERE) WITH OBJECT (HELD CARRIED HAVE TAKE)
            ON OBJECT (FIND READBIT) = V-FWRITE-THIRD PRE-FWRITE-THIRD>
    <SYNTAX WRITE ABOUT OBJECT (EVERYWHERE) WITH OBJECT (HELD CARRIED HAVE TAKE)
            IN OBJECT (FIND READBIT) = V-FWRITE-THIRD PRE-FWRITE-THIRD>>
...
<SYNTAX HEAD BEHIND OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-THROUGH PRE-THROUGH>
<SYNTAX HEAD DOWN OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-CLIMB-DOWN>
<SYNTAX HEAD IN OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-THROUGH PRE-THROUGH>
...
<SYNTAX HEAD THROUGH OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-THROUGH PRE-THROUGH>
<SYNTAX HEAD TO OBJECT (EVERYWHERE) = V-WALK-TO>
<SYNTAX HEAD NEAR OBJECT (EVERYWHERE) = V-WALK-TO>
<SYNTAX HEAD UP OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-CLIMB-UP>
<SYNTAX HEAD WITH OBJECT (EVERYWHERE) = V-FOLLOW>
<SYNTAX HEAD OBJECT OVER OBJECT = V-RUN-OVER>
<SYNTAX HEAD OBJECT THROUGH OBJECT (ON-GROUND IN-ROOM ADJACENT) = V-THROUGH PRE-THROUGH>
...
<SYNTAX YELL UP OBJECT (FIND PERSONBIT) = V-SMILE>

<SYNONYM YES Y OK OKAY SURE YUP YEP YEAH AYE INDEED K KK
             CORRECT ALRIGHT COURSE FINE YA YAH POSITIVE
             AFFIRMATIVE>
<SYNTAX YES = V-YES>
